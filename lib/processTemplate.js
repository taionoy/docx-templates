...
var processCmd = function (data, node, ctx) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 15:
                if (!(cmdName === 'CALL')) return [3 /*break*/, 18];
                if (!(!(0, reportUtils_1.isLoopExploring)(ctx) && ctx.options.additionalJsContext.call)) return [3 /*break*/, 17];
                return [4 /*yield*/, ctx.options.additionalJsContext.call(data, cmdRest, ctx)];
            case 16:
                _b.sent();
                _b.label = 17;
            case 17: return [3 /*break*/, 33];
            case 18:
                if (!(cmdName === 'IMAGE')) return [3 /*break*/, 24];
                if (!!(0, reportUtils_1.isLoopExploring)(ctx)) return [3 /*break*/, 23];
                return [4 /*yield*/, (0, jsSandbox_1.runUserJsAndGetRaw)(data, cmdRest, ctx)];
            case 19:
                img = _b.sent();
                if (!(img != null)) return [3 /*break*/, 23];
                _b.label = 20;
            case 20:
            ...
            case 24:
                if (!(cmdName === 'LINK')) return [3 /*break*/, 28];
                if (!!(0, reportUtils_1.isLoopExploring)(ctx)) return [3 /*break*/, 27];
                return [4 /*yield*/, (0, jsSandbox_1.runUserJsAndGetRaw)(data, cmdRest, ctx)];
            case 25:
                pars = _b.sent();
                if (!(pars != null)) return [3 /*break*/, 27];
            ...
            case 28:
                if (!(cmdName === 'HTML')) return [3 /*break*/, 32];
                if (!!(0, reportUtils_1.isLoopExploring)(ctx)) return [3 /*break*/, 31];
                return [4 /*yield*/, (0, jsSandbox_1.runUserJsAndGetRaw)(data, cmdRest, ctx)];
            case 29:
                html = _b.sent();
                if (!(html != null)) return [3 /*break*/, 31];
                return [4 /*yield*/, processHtml(ctx, html)];
            case 30:
                _b.sent();
                _b.label = 31;
            case 31: return [3 /*break*/, 33];
            case 32: throw new errors_1.CommandSyntaxError(cmd);
