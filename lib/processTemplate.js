...
var processCmd = function (data, node, ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var cmd, _a, cmdName, cmdRest, aliasMatch, aliasName, fullCmd, result, nerr, str, literalXmlDelimiter, result, nerr, str, literalXmlDelimiter, img, e_1, pars, html, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 15:
                if (!(cmdName === 'CALL')) return [3 /*break*/, 21];
                if (!(!(0, reportUtils_1.isLoopExploring)(ctx) && ctx.options.additionalJsContext.call)) return [3 /*break*/, 20];
                return [4 /*yield*/, ctx.options.additionalJsContext.call(data, cmdRest, ctx)];
            case 16:
                result = _b.sent();
                if (result == null) {
                    return [2 /*return*/, ''];
                }
                if (!(typeof result === 'object' && !Array.isArray(result))) return [3 /*break*/, 19];
                nerr = new errors_1.ObjectCommandResultError(cmdRest);
                if (!(ctx.options.errorHandler != null)) return [3 /*break*/, 18];
                return [4 /*yield*/, ctx.options.errorHandler(nerr, cmdRest)];
            case 17:
                result = _b.sent();
                return [3 /*break*/, 19];
            ...
            case 21:
                if (!(cmdName === 'IMAGE')) return [3 /*break*/, 27];
                if (!!(0, reportUtils_1.isLoopExploring)(ctx)) return [3 /*break*/, 26];
                return [4 /*yield*/, (0, jsSandbox_1.runUserJsAndGetRaw)(data, cmdRest, ctx)];
            case 22:
                img = _b.sent();
                if (!(img != null)) return [3 /*break*/, 26];
                _b.label = 23;
            case 23:
            ...
            case 27:
                if (!(cmdName === 'LINK')) return [3 /*break*/, 31];
                if (!!(0, reportUtils_1.isLoopExploring)(ctx)) return [3 /*break*/, 30];
                return [4 /*yield*/, (0, jsSandbox_1.runUserJsAndGetRaw)(data, cmdRest, ctx)];
            case 28:
                pars = _b.sent();
                if (!(pars != null)) return [3 /*break*/, 30];
            ...
            case 31:
                if (!(cmdName === 'HTML')) return [3 /*break*/, 35];
                if (!!(0, reportUtils_1.isLoopExploring)(ctx)) return [3 /*break*/, 34];
                return [4 /*yield*/, (0, jsSandbox_1.runUserJsAndGetRaw)(data, cmdRest, ctx)];
            case 32:
                html = _b.sent();
                if (!(html != null)) return [3 /*break*/, 34];
                return [4 /*yield*/, processHtml(ctx, html)];
            case 33:
                _b.sent();
                _b.label = 34;
            case 34: return [3 /*break*/, 36];
            case 35: throw new errors_1.CommandSyntaxError(cmd);
...
function getCommand(command, shorthands, fixSmartQuotes) {
    ...
    if (cmd[0] === '*') {
        ...
        cmd = "CALL ".concat(cmd.slice(1).trim());
    }
